...
class Whisper80Extractor(BaseModel):
    def __init__(self, 
                 model_name: str="Whisper80" ,
                 model_path: str="models/Whisper80", 
                 feature_list: list=[],
                 gpu_id: int=None,
...
if __name__ == "__main__":
    extractor = Whisper80Extractor(model_path="models/Whisper80", device="cuda")
